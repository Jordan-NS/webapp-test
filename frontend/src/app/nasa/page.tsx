...
export default function NasaPage() {
  ...
  const fetchDailyImage = useCallback(async () => {
    try {
      ...
      console.log('Buscando imagem do dia...');
      
      const response = await api.get('/apod/sync');
      console.log('Resposta da API (imagem do dia):', response.data);
      ...
      console.error('Erro detalhado (imagem do dia):', err);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <button
        ...
        className="mb-4 px-6 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-300"
      >
        Botão de Teste
      </button>
